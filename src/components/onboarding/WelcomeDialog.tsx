...
export const WelcomeDialog = ({ isOpen, onOpenChange }: WelcomeDialogProps) => {
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Welcome to EVE!</DialogTitle>
        </DialogHeader>
        <DialogDescription>
          ...
          <br />
          <br />
          You have access to the platform’s newest features: an intuitive chat
          interface, session memory, and integrated feedback tools. You will
          also be invited to share your experience through quick surveys,
          interviews, and online or in-person workshops.
          <br />
          <br />
